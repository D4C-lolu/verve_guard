...
ALTER TABLE public.roles
    ADD CONSTRAINT role_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users (id) ON DELETE SET NULL;
...
CREATE TABLE IF NOT EXISTS public.transactions (
    ...
    CONSTRAINT transactions_account_fkey FOREIGN KEY (account_id) REFERENCES public.accounts (id) ON DELETE RESTRICT,
...
CREATE TABLE IF NOT EXISTS public.transfers (
    ...
    from_account_id                         character varying (26) NOT NULL,
    to_account_id                           character varying (26) NOT NULL,
    amount                                  numeric (19, 4) NOT NULL,
    currency                                character varying (3) NOT NULL,
...
ALTER TABLE public.transactions
    ADD COLUMN transfer_id                  character varying (26),
